 ...
 class Clock_Widget extends WP_Widget{
	...
	public function __construct() {
		parent::__construct(
			...
			'Clock', // Name
			[ 'description' => __( 'Clock Widget', 'ayodoya' ) ] // Args
		);
	}
	/**
	...
	public function form( $instance ) {
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'Clock', 'ayodoya' );
		}
		?>
		<p>
			<label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php _e( 'Title:', 'ayodoya' ); ?></label>
